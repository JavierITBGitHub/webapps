...
/* Meteo Seva - Reescrit sense async/await per seguretat en navegadors del 2018 */
...
function updateContinuous() {
    ...
    /* Ratlla hora + minut (reescrit sense arrow functions ni toggle complex) */
...
/* Nota: S'ha eliminat l'esdeveniment click/double-tap requestFullscreen. 
   A iOS la pantalla completa real es força iniciant l'app des de la icona de l'escriptori de l'iPad */
