...
const updateClock = () => {
    ...
    // Actualització de la data en català
    const dies = ['Diumenge', 'Dilluns', 'Dimarts', 'Dimecres', 'Dijous', 'Divendres', 'Dissabte'];
    const diaNom = dies[now.getDay()];
    const diaNum = now.getDate();
    dateElement.innerText = `${diaNom} ${diaNum}`;
};
